...
def myGet():
    ...
    while True:
        ...
        if np.linalg.matrix_rank(A) == np.linalg.matrix_rank(Ab):
            ...
            telos = Label(f13, text=(solver(A, b, dim1, dim2)), font=("Arial", 14), fg='black', bg='cadet blue')
...
def main(value):
    if value == "import":
        ...
        myLabel1 = Label(f3, text="Δώσε δίασταση του πίνακα (Πρωτα γραμμες, μετα στηλες)", font=("Arial", 14, 'bold'),
                         fg='black', bg='LightSkyBlue1').pack()
        global e
        ...
        myLabel2 = Label(f5, text="Ναι ή οχι αν είναι διαγώνιος", font=("Arial", 14, 'bold'), fg='black',
                         bg='LightSkyBlue1').pack()
        t = Radiobutton(f6, text='Yes', font=("Arial", 14, 'bold'), fg='#000000', bg='LightSkyBlue1', pady='3',
                        variable=diap, value=True)
        t.grid(row=0, column=0, padx=3)
        h = Radiobutton(f6, text='No', font=("Arial", 14, 'bold'), fg='#000000', bg='LightSkyBlue1', pady='3',
                        variable=diap, value=False)
        h.grid(row=0, column=1, padx=3)
        myLabel3 = Label(f7, text="Πλήθος μη μηδενικών στοιχείων", font=("Arial", 14, 'bold'), fg='black',
                         bg='LightSkyBlue1').pack()
        global p
...
def restart():
    root.destroy()
    os.startfile("project code latest version mixed numba.pyw")
